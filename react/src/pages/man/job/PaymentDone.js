    ...
    return (
      <div className={classes.root}>
        ...
        <Typography className={classes.title}>
          Thanks for your payment, the date is confirmed, you can get in touch
          with the girls by lol chat
        </Typography>
        <div>
          <MainButton
            className={classes.button}
            onClick={() => this.setState({ redirect: "/m/addLolChat" })}
          >
            Start chatting with lol chat
          </MainButton>
          <MainButton
            className={classes.button}
            onClick={() => this.setState({ redirect: "/m/addLolChat" })}
